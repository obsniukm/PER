...
In order to justify the classification of an excerpt as a particular computational practice, we needed to identify the various characteristics within that excerpt in a systematic way.  Given that each excerpt is only a part of the whole transcript, we followed a process of providing rationale at three different levels: at the level of the framework, at the level of the individual excerpt, and at the level of multiple related excerpts.  Each level of the coding process is described in detail below.

At the level of the individual excerpt, The "abstractions" that the group is developing are the mass of the Earth (line 501), the radius of the Earth (line 502), and the universal gravitational constant (line 507).  For example,.

At the level a multiple related excerpts, The "goal" that they are working toward is creating a Newtonian gravitational force acting on the satellite.  For example,.

At the level of the framework, The group is creating "abstractions" as they work toward a "goal.".  For example,.

These three levels of rationale, though not necessarily persuasive individually, when taken together can provide a reasonable justification for the classification of an excerpt as belonging to a particular computational practice.  However, in order to ensure this reasonable justification, an iterative process of inter-rater reliability is followed.  This process of generating confidence and inter-rater reliability is described in more detail below.
