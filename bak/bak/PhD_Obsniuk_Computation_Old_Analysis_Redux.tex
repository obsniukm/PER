...
Our full analysis involves many different stages: first the inital data was collected and susequently reduced in order to provide a manageable set of data, second an independent coding scheme was generated -- using the Weintrop framework -- to help identify computational practices, and three inter-raters were used to ensure reliability of the analysis.  Each of these stages are detailed below.
...
With these practices identified, we then analyzed their frequency.  Many practices showed up frequently, and some showed up almost never.  Analysis of these simple statistics, represented visually in Fig.~\ref{CH5:DensityPlot}, gives us a concrete way to hone in and focus our analysis on the most important (or at least frequent) practices.  The most important practices were then further analyzed for the variation in the characteristics that make up each practice.
