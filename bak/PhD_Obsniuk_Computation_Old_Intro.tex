...
Ever since the advent of relatively inexpensive and powerful computers, researchers have been interested in their use as both professional and pedagogical tools.  Their ability to quickly and precisely perform numerical integration makes them well suited for problems in the STEM fields.  Similarly, their ability to easily generate stunning and meaningful visualizations also makes well suited for problems in the STEM fields.  
...
Computation is important not only in terms of modern research in professional domains, but also as a pedagogical tool in educational domains.  Obviously, the particular skills any professional will need to be proficient in will depend on the particular job.  However, focusing on the general and broadly applicable practices that students should engage in while solving complex problems in the STEM fields is reasonable place to focus research.

Recently, many calls have been made for increasing computation into the curriculum at many levels of education, from elementary to graduate school\cite{}.
...
Computational thinking, although it is not well defined, 
