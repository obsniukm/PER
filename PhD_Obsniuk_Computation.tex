...
In the sections that follow, we present our findings of the common, less common, and unobserved practices within our data set.  The common practices are those that were identified at least three times in a majority of the groups.  The less common practices are the remaining of the observed practices.  The unobserved practices were not identified at all.  Along with some of the statistics of the frequencies of these practices (i.e., raw numbers and percentages), we provide their definitions and reference detailed examples.  Additionally, we provide discussion as to why a particular practice might have a given frequency.

\subsection{Common practices}

Many of the practices laid out by the framework have been identified multiple times in almost every group that was analyzed.  Accordingly, these practices (listed in Tab.~\ref{CH6:Common}) are deemed common and are given a fair amount of attention.  It is important to pay a fair amount of attention to these practices because, as instructors, we not only want students to correctly accomplish tasks, but we also want to make sure that they are engaging in things like critical and computational thinking.  Being able to identify and encourage these practices as they occur (or don't occur) in a classroom, therefore, is crucial to effective teaching.  Accordingly, we must have clear and reliable definitions for each of the common practices.

\begin{table}[hb]\centering
\begin{tabular}{llll}\hline\hline
Practice & Number & Percentage of category & Percentage of all\\\hline
Creating data & 27 & 31.4 & 9.2 \\
Analyzing data & 23 & 26.7 & 7.8 \\
Visualizing data & 36 & 41.8 & 13.0 \\
Designing models & 32 & 33.0 & 11.0 \\
Constructing models & 18 & 18.6 & 6.1 \\
Assessing models & 27 & 27.8 & 9.2\\
Creating abstractions & 22 & 26.8 & 7.5 \\
Programming & 21 & 25.6 & 7.1 \\
Troubleshooting and debugging & 24 & 29.3 & 8.2 \\
Thinking in levels & 18 & 33.3 & 6.1 \\
Communicating information & 23 & 42.6 & 7.8 \\\hline\hline
\end{tabular}
\caption{The computational practices that have been deemed common are shown with the number of times each practice was identified, the percentage of its category that it occupies, and the percentage of all the practices that it occupies.}\label{CH6:Common}
\end{table}
