...
To summarize, there are a number of reasons that we commonly observed these practices.  Specifically, the learning goals of being able to use mathematical and computational thinking (P4), analyze and interpret data (P3), develop and use models (P1), and obtain, evaluate, and communicate information (P7) all seem to strongly influence the practices that we observe.  Further, many of the tutor interactions help to facilitate these practices given the design of the course.
...
One reason that we observe understanding concepts less commonly within our data might be that certain groups are more or less focused on understanding the underlying concepts.  A group with at least one member that is highly motived to develop an understanding of the underlying concepts will likely engage in this practice more often.  However, this is a relatively rare occurrence, and so we only see this practices less commonly relative to the rest.  Overall, we want students in ${\rm P}^{3}$ to be able to use computers to learn physical concepts, and to be able to communicate their understanding with them.
...
One reason that we observe finding and testing solutions less commonly within our data might be that certain groups are more or less apt to justify their actions.  A group with at least one member that is highly motived to justify each action taken will likely engage in this practice more often.  However, this type of logical justification is rather difficult, and so we only see this practices less commonly relative to the rest.  Ultimately, we want students in ${\rm P}^{3}$ to be able to find different force model and to be able to justify them in terms of the applicability to various situations.
...
One reason that we observe assessing solutions less commonly within our data might be that certain groups are more or less likely to explicitly compare different solutions.  A group with at least one member that is highly motived to compare the pros and cons of different solutions will likely engage in this practice more often.  However, most groups take a guess and check approach, rather than a contrast and compare approach, and so we only see this practices less commonly relative to the rest.  Overall, we want students in ${\rm P}^{3}$ to be able to explain the differences, both qualitative and quantitative, between various force models.
...
One reason that we observe investigating systems as a whole less commonly within our data might be that certain groups are more or less able to step back and take a look at the picture as a whole.  A group with at least one member that is making sure they do not get lost in the details will likely engage in this practice more often.  However, many groups struggle with the details and spend most of their focusing on them, and so we only see this practices less commonly relative to the rest.  Overall, we wanted students in ${\rm P}^{3}$ to be able to make sense of/interpret the data generated by a system as it pertains to the phenomenon under investigations, in addition to how it pertains to the underlying model.
...
One reason that we observe understanding relationships less commonly within our data might be that certain groups are more or less mathematically inclined.  A group with at least one member that has a strong mathematical background (e.g., is proficient at taking mathematical limits) will likely engage in this practice more often.  However, having this level of mathematical background is relatively rare at the introductory physics level, and so we only see this practices less commonly relative to the rest.  Overall, we want students in ${\rm P}^{3}$ to understand that different mathematical relationships result in different types of physical behavior.

To summarize, there are a number of reasons that we observed these practices.  Specifically, the learning goals of being able to engage in argument from evidence (P6), obtain, evaluate, and communicate information (P7), construct explanations (P5), plan and carry out investigations (P2), and develop and use models (P1) all seem to influence the practices that we observe.  Further, many of the tutor interactions help to facilitate these practices given the design of the course.  Additionally, the reasons as to why we only observe these practices less commonly, aside from the limitations of the framework and the course design, may be due to the variation in student preparation coming into the course.
