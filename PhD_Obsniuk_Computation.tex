...
The preceding examples of Sec.~\ref{CH5:Practices} are meant to clearly and succinctly illustrate some of the common computational practices that we have observed in our data.  They are the result of an iterative and multi-stage process of analysis involving the collection and reduction of data, the development of an independent coding scheme, and the building of confidence through inter-rater reliability (see Sec.~\ref{CH5:Analysis}).  Through the aforementioned coding process and inter-rater discussion, the fundamental characteristics for each practice have been identified and defined (e.g., see Tab.~\ref{CH5:CommunicatingInformation}).

However, the characteristics and qualities that we have defined do not come without their limitations, and are often steeped in nuance.  Frequently, the delineation between one practice and another can be blurred, with many shared characteristics across the categories.  Accordingly, the following chapter will focus on the specific and more general limitations of our analysis, as well the subtle nuances associated with some of the more complicated excerpts and practices.  
...
Many of the characteristics that we have identified follow a logical progression.  Consider the characteristics of the practice of designing a computational model: (i) defining the components of a model, (ii) relating the components to one another, and then (iii) making predictions based on the model.  However, these characteristics need not be identified in this linear manner.

For example, in Excerpt 11 from Group B (see Tab.~\ref{CH5:DesigningModels}), they can first be seen discussing the predictions that they plan to make with their program.  These predictions are articulated before they even have a proposal for a particular force model.  Once they have agreed on the predictions that they must make, they then begin to design the appropriate model.  Thus, the characteristics indeed need not follow linearly or logically.
...
\section{Coccurrences}

It is important to note that, although our analyses have focused on identifying and defining a single practice pertaining to a single excerpt, many excerpts contain multiple practices.  Furthermore, some characteristics are shared between many practices.
