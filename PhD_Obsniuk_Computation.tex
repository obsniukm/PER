...
\SC: Okay.
\end{description}  Here, the tutor is suggesting that they produce a graph, which can be used to convey information about how close the satellite is to perfectly geostationary.  This conveying of information about the geostationary nature of the orbit is efficiently accomplished through the production of a graph.
