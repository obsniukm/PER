...
For example, consider Excerpt 2 from Group I in the following analysis.  Broadly, the group can be seen working to incorporate realistic values into their MWP.  A couple of minutes into their starting the problem (See.~\ref{CH3:SatelliteProblem}), they modify the pre-written numerical value for the mass of the satellite from 1 to 1E4.  This leads, over the course of about thirty minutes, to the group defining the momentum of the satellite as a function.  In other words, the group can be seen \textit{isolating} and \textit{correcting} an unexpected error in a \textit{systematic way}.
