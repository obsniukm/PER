...
\caption{A portion of transcript meant to highlight the indication of unspoken and inferred actions.}\label{CH5:Transcript}
\end{figure}
...
\begin{figure}\centering
\includegraphics[scale=0.45]{./images/CH5Transcript.pdf}
\caption{A portion of transcript.}\label{CH5:OffTopic}
\end{figure}
