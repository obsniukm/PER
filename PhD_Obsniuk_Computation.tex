...
Describe the three sections that follow.
...
Why do these show up commonly?

Why is important to identify the commonly observed practices?
...
sdf & sdf \\\hline\hline
\end{tabular}
\caption{Common practices.}\label{CH6:Common}
\end{table}
...
sdf & sdf \\\hline\hline
\end{tabular}
\caption{Less common practices.}\label{CH6:LessCommon}
\end{table}
...
sdf & sdf \\\hline\hline
\end{tabular}
\caption{Unobserved practices.}\label{CH6:Unobserved}
\end{table}
