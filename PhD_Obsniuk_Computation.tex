...
Along with the development of VPython, a software called Easy Java Simulations (EJS) was increasing in use.  The EJSs were meant to give students a little more control behind the scences like VPython, while still limiting the generalizability like PhET simulations.

% Expand on PhET simultions.
...
More recently, there has been an explosion of the delivery of computational physics problems in the undergraduate curriculum.  The advent of high level programming languags and inexpensive computers has all but caused this.  There are many different implementations (cite 20) -- however, research to improve that delivery has been lacking.  Some of the critical results, though, are described below.

% Expand on Weatherford
